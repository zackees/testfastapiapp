...
from testfastapiapp.log import get_log_reversed, make_logger
from testfastapiapp.settings import API_KEY, IS_TEST
from testfastapiapp.util import async_download
from testfastapiapp.version import VERSION
...
APP_DISPLAY_NAME = "testfastapiapp"
...
def main() -> None:
    ...
    uvicorn.run(
        "testfastapiapp.app:app", host="localhost", port=port, reload=True
    )
